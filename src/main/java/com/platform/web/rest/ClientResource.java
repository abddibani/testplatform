...
/**
 * REST controller for managing {@link com.platform.domain.Client}.
 */
@RestController
@RequestMapping("/api")
public class ClientResource {
    ...
    public ResponseEntity<ClientDTO> updateClient(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, clientDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<ClientDTO> partialUpdateClient(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, clientDTO.getId())
        );
    }
