  ...
  describe('Order Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call Client query and add missing value', () => {
        ...
        const client: IClient = { id: 'fe16f705-da31-40d9-88d6-3dc9718785e8' };
        order.client = client;

        const clientCollection: IClient[] = [{ id: '1cc139f4-b880-485e-becb-f29e77acdc00' }];
      ...
      it('Should update editForm', () => {
        const order: IOrder = { id: 'CBA' };
        const client: IClient = { id: 'fece3353-2534-4f6c-b007-f1e353e81b51' };
        order.client = client;
